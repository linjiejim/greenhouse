...
const featureRequestSchema = z.object({
  ...
  admin_note: z.string().optional().describe('Super-user note/comment (for update)'),
});
...
Super users can list/update all requests; team users can create new requests.`,
  category: 'team',
  is_global: true,
  icon: 'Lightbulb',
  runtime_risk: 'r1',
