...
const MODULE_PAGES: ModulePageContract[] = [
  ...
  { file: './users.tsx', moduleId: 'admin.users', layout: 'list' },
  { file: './usage-enhanced.tsx', moduleId: 'admin.usage', layout: 'list' },
  { file: './feature-requests.tsx', moduleId: 'admin.feature-requests', layout: 'list' },
  ...
  { file: './admin-llm-gateway.tsx', moduleId: 'admin.llm-gateway', layout: 'list' },
  { file: './mcp-keys.tsx', moduleId: 'admin.mcp-keys', layout: 'list' },
  { file: './runtime-config.tsx', moduleId: 'admin.runtime-config', layout: 'form' },
  { file: './branding-studio.tsx', moduleId: 'admin.branding', layout: 'canvas' },
  { file: './prompts.tsx', moduleId: 'workspace.tasks', layout: 'list' },
  ...
  { file: '../tasks/task-center.tsx', moduleId: 'workspace.executions', layout: 'list' },
