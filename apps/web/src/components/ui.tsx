 ...
 *  (and therefore the active theme's primary color inside AppLogo). */
export function GreenhouseMark({ className }: { className?: string }) {
  return (
    <svg
      viewBox="9 7 112 112"
      className={className}
...
export function AppLogo({
  ...
  const mark = (
    ...
    >
      <GreenhouseMark className={iconSizeClasses[size]} />
    </div>
  );
  if (logoOnly) {
    return mark;
