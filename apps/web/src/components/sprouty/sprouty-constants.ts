/**
 * Sprouty constants — colors, sizes, variants, and reusable avatar accessories.
 */
...
export type EyeStyle = 'classic' | 'dot' | 'soft' | 'focused';

export const EYE_STYLES: { id: EyeStyle; name: string; description: string }[] = [
  { id: 'classic', name: 'Classic', description: 'Bright, expressive eyes' },
  { id: 'dot', name: 'Dot', description: 'Minimal and crisp at small sizes' },
  { id: 'soft', name: 'Soft', description: 'Rounder, gentler expression' },
  { id: 'focused', name: 'Focused', description: 'Calm and professional' },
];
...
export const ACCESSORIES: AccessoryMeta[] = [
  ...
  { id: 'watering-can', name: 'Watering Can', type: 'held', emoji: '💧' },
  { id: 'book', name: 'Open Book', type: 'held', emoji: '📖' },
  { id: 'briefcase', name: 'Briefcase', type: 'held', emoji: '💼' },
];
