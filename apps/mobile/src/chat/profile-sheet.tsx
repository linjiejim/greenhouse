...
import { Icon, Sheet, Skeleton, Touchable } from '../ui';
        ...
        <FlatList
          ...
          renderItem={({ item }) => {
            ...
            return (
              ...
              >
                <View style={[styles.rowIcon, active && { backgroundColor: c.accentTint }]}>
                  <Icon name="sparkle" size={18} color={active ? c.accentDeep : c.fgMuted} />
                </View>
...
const useStyles = makeStyles((c) => ({
  hint: { fontSize: 12.5, color: c.fgMuted, marginBottom: 10, paddingHorizontal: 2 },
  row: {
    flexDirection: 'row',
    alignItems: 'center',
    gap: 12,
  ...
  rowTitle: { fontSize: 15.5, fontWeight: '600', color: c.fg, flexShrink: 1 },
  rowDesc: { fontSize: 12.5, color: c.fgMuted, marginTop: 3, lineHeight: 17 },
  rowModel: { fontSize: 11, color: c.fgFaint, marginTop: 4 },
  badge: {
    backgroundColor: c.surfaceMuted,
  ...
  badgeText: { fontSize: 10.5, fontWeight: '600', color: c.fgMuted },
}));
